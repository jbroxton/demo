...
interface RequirementsTableNodeViewProps {
  node: {
    attrs: {
...
export default function RequirementsTableNodeView({ node }: RequirementsTableNodeViewProps) {
  const featureId = node.attrs.featureId;
