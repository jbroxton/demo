...
interface ThemedDataTableToolbarWithAddBtnProps<TData> {
  table: Table<TData>
  onDeleteSelected?: (selectedRows: TData[]) => void
  onAddRequirement?: () => void
}

export function ThemedDataTableToolbarWithAddBtn<TData>({
  table,
  onDeleteSelected,
  onAddRequirement,
}: ThemedDataTableToolbarWithAddBtnProps<TData>) {
