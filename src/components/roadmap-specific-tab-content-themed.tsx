...
export function RoadmapSpecificTabContentThemed({
  roadmapId,
  tabId,
  isNew = false
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-4 border-b border-white/[0.03] grid grid-cols-2">
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent className="bg-[#232326] border-[#2a2a2c] text-white max-w-md">
          <DialogHeader>
