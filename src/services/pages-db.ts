...
import { Block, BlockType, CreateBlockInput } from '@/types/models/Block';
...
export async function addBlockToPage(
  ...
  try {
    ...
    // Create new block - add ID and timestamps (will be generated by database but needed for type)
    const newBlock: Block = {
      ...block,
      id: crypto.randomUUID(), // Temporary ID for type safety - real ID generated by database
